...
<div class="main">
  <div class="sign">
    <div class=""><img src="../../../static/img/qdBanner.jpg" class="img-responsive"></div>
    <div class="calendar">
        <div>
   ...
   <div class="qiandao_box">
      <button class="btn " @click="signIn">马上签到</button>
    </div>

   <div class="maskbox"></div>
  <div class="qdbox">
    <div class="text-center text-green font18"><strong>签到成功！</strong></div>
    <div class="text-center pt10">您已经签到&nbsp;<span class="text-green">1</span>&nbsp;天</div>
    <div class="text-center ptb15"><img src="../../../static/img/gift.png" style="width:125px;margin-left:20px;"></div>
    <div class="text-center" @click="close"><button class="btn btn-lottery">关闭</button></div>
  </div>
  </div>
</div>
</template>
...
export default {
    ...
    methods: {
       signIn(){
          ...
          var qdbox = document.querySelector(".qdbox");
          var selected = document.querySelector(".selected");
          maskbox.style.display="block"
          qdbox.style.display="block"
